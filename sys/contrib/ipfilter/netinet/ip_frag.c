/*	$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_frag.c,v 1.33 2007/10/18 21:52:13 darrenr Exp $	*/
...
static const char rcsid[] = "@(#)$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_frag.c,v 1.33 2007/10/18 21:52:13 darrenr Exp $";
